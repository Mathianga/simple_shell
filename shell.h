...
/**
 * struct info- struct for the prog data
 * @program_name: the name of the exe
 * @input_line: it points to the input read for _getline
 * @command_name: it points to the first command typed by the user
 * @exec_counter: number of exce comands
 * @file_descriptor: a file descriptor to the input of commands
 * @tokens: it points to array of tokenized input
...
/* Initialize the struct with the information of the program */
